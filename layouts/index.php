...
<link rel="stylesheet" href="templates/je-construct-pro/css/bootstrap.min.css" type="text/css" media="screen" />
						...
						<?php if ($contentAboveCount) : ?>
							...
							<?php if ($this->countModules('content-above-1')) : ?>
								<div id="content-above-1" class="<?php echo $contentAboveClass ?>">
									<jdoc:include type="modules" name="content-above-1" style="jexhtml" />
