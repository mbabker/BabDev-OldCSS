...
<div class="ars-browse-items">
	...
	<div>
		<?php
			...
			$link = str_replace('<a ','<a class="btn" rel="nofollow"', $link);
			$link = str_replace(
				JText::_('LBL_ITEM_DOWNLOAD') . '</a>',
				'<span class="icon-box-add"></span> ' . JText::_('LBL_ITEM_DOWNLOAD') . '</a>',
				$link
			);
			echo $link;
		?>
		...
		<?php
			...
			$link = str_replace('<a ','<a class="btn" rel="nofollow"', $link);
			$link = str_replace(
				JText::_('COM_ARS_LBL_ITEM_DIRECTLINK') . '</a>',
				'<span class="icon-box-add"></span> ' . JText::_('COM_ARS_LBL_ITEM_DIRECTLINK') . '</a>',
				$link
			);
			echo $link;
		?>
