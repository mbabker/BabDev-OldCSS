...
class PlgContentBdpagenav extends JPlugin
{
	 ...
	 *
	 * @return  mixed  HTML markup on success
	 *
	 * @since	1.0
	 */
	public function onContentBeforeDisplay($context, &$row, &$params, $page=0)
	{
		...
		// Check if in the print view
		if ($print)
		{
			return;
		}

		// Ensure we are in the article view
		if ($context != 'com_content.article' && $view != 'article')
		{
			return;
		}

		// Only run if the show_item_navigation param is enabled
		if ($params->get('show_item_navigation'))
		{
			$html = '';
			$db = JFactory::getDbo();
